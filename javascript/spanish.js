	...
	LLSpanish = {
		business : {
			words : {
				...
				translated : ["plan de negocios", "organizar", "ingresos"],
				images : ["business-plan2.jpg", "how-to-organise2.jpg", "Revenue2.jpg"],
				description : [" ", " ", " "]	
			},
			phrases : {
				english : ["pleased to meet you (m)", "How's it going?", "How are you today?"],
				translated : ["encantado", "¿Cómo te va?", "Cómo está hoy?"],
				images : ["pleaseToMeetYou2.jpg", "howzitgoing2.jpg", "howareYouToday2.jpg"],
			...
			conversations : {
				...
				translated : ["Déjame presentarme. Mi nombre es...", "Apreciamos hacer negocios con usted.", "Te quiero presentar a una amiga. Juan, te presento a Maria.", "Debemos prepararnos para lo peor."],
				images : ["Letmeintoducemyself2.jpg", "Thank-you-for-your-Business2.jpg", "introduce-female-friend2.jpg", "WeShouldbepreparedfortheWorst2.jpg"],
				description : [" ", " ", " ", " "]		
			}
		},
		tourist : {
			words : {
				english : ["Soup", "Water", "Juice"],
				translated : ["Sopa", "Agua", "Jugo"],
				images : ["soup2.jpg", "water2.jpg", "Juice2.jpg"],
				description : [" ", " ", " "]	
			...
			phrases : {
				...
				images : ["place2.jpg", "subway2.jpg", "whichdirection2.jpg"],
				description : [" ", " ", " "]	
			...
			conversations : {
				...
				images : ["idontunderstand2.jpg", "i_have_reservation2.jpg", "HowMuchIsIt2.gif", "tip.gif"],
		...
		everyday : {
			words : {
				...
				translated : ["(Yo) Quiero", "Yo necesito", "ir", "ordenar/pedir", "tomar/beber", "cocinar/cocer"],
				images : ["i-want-my-toy-back2.jpg", "i-need2.jpg", "togo2.jpg", "toOrder2.jpg", "toDrink2.jpg", "toCook2.jpg"],
			...
			phrases : {
				...
				images : ["IDontWant2.jpg", "how-much2.jpg", "repeatPlease2.gif", "excuseme1.cms"],
