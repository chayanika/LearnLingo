	...
	LLSpanish = {
		business : {
			words : {
				...
				images : ["business-plan.jpg", "toorganize.jpg", "Revenue.jpg"],
				description : [" ", " ", " "]	
			},
			phrases : {
			...
			conversations : {
				...
				images : ["Letmeintoducemyself.jpg", "Thank-you-for-your-Business.jpg", "introduce-female-friend.jpg", "WeShouldbepreparedfortheWorst.jpg"],
				description : ["", "", ""]		
			}
		},
		tourist : {
			words : {
				...
				images : ["soup.jpg", "water.jpg", "Juice.jpg"],
				description : [" ", " ", " "]	
		...
		everyday : {
			words : {
				...
				images : ["i-want-my-toy-back.jpg", "i-need.jpg", "togo.jpg", "toOrder.jpg", "toDrink.jpg", "toCook.jpg"],
			...
			conversations : {
				...
				images : ["store.jpg", "whatIsYourName.jpg", "DoYouSpeakSpanish.jpg"],
				description : [" ", " ", " "]	
